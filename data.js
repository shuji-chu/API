const allApis = {
    ...
    query: [
        { id: 'query_1', name: 'IP查询', desc: '查询IP归属地', method: 'GET', endpoint: '/api/v1/query/ip', params: [{ name: 'ip', type: 'string', required: true, desc: 'IP地址' }], example: 'GET /api/v1/query/ip?ip=8.8.8.8' }
    ],
    service: [
